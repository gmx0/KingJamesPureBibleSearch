...
public:
	...
	QStringList m_lstRawAltWords;				// Reduced Words, without hyphens, without apostrophies, in original case -- used for ELS and places where letters-only need to be used
